...
class InteractionsControllerTest < ActionController::TestCase
  ...
  test "should create interaction" do
    assert_difference('Interaction.count') do
      post :create, interaction: { customer_id: @interaction.customer_id, description: @interaction.description, time: @interaction.time, type: @interaction.type }
    end
  ...
  test "should update interaction" do
    patch :update, id: @interaction, interaction: { customer_id: @interaction.customer_id, description: @interaction.description, time: @interaction.time, type: @interaction.type }
    assert_redirected_to interaction_path(assigns(:interaction))
  end
